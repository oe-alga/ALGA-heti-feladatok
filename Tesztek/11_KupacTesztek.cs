...
//         {
//             PrioritasosSor<int> s = new KupacPrioritasosSor<int>(2);
//             s.Sorba(1);
//             s.Sorba(2);
//             s.Sorba(3);
//         }
...
//         {
//             PrioritasosSor<int> s = new KupacPrioritasosSor<int>(5);
//             s.Sorba(1);
//             s.Sorba(2);
//             s.Sorba(3);
//             s.Sorbol();
...
//         {
//             PrioritasosSor<int> s = new KupacPrioritasosSor<int>(10);
//             s.Sorba(1);
//             s.Sorba(4);
...
//             PrioritasosSor<PrioritasosSzoveg> s = new KupacPrioritasosSor<PrioritasosSzoveg>(10);
//             s.Sorba(a);
//             s.Sorba(b);
//             s.Sorba(c);
//             s.Sorba(d);
...
// 
//     [TestClass()]
//     public class KupacTesztekKulsoFuggvennyel
//     {
//         /// <summary>
...
//         {
//             KupacPrioritasosSor<string> ps = new KupacPrioritasosSor<string>(10);
//             ps.Sorba("oszibarack");
//             ps.Sorba("alma");
//             ps.Sorba("korte");
//             ps.Sorba("birsalma");
...
//         {
//             int[] A = new int[] { 1, 3, 2, 4, 9, 12, 32, 21, 12, 8, 11 };
//             _ = new Kupac<int>(A);
// 
...
//         {
//             int[] A = new int[] { 5, 8, 7, 0, 9, 6, 4, 1, 3, 2 };
