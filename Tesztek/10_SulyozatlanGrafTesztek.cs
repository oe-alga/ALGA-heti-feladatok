...
//         {
//             CsucsmatrixSulyozatlanGraf csg = new CsucsmatrixSulyozatlanGraf(2);
...
//         {
//             CsucsmatrixSulyozatlanGraf csg = new CsucsmatrixSulyozatlanGraf(3);
//             csg.UjEl(0, 1);
//             csg.UjEl(0, 2);
//             csg.UjEl(1, 2);
// 
...
//         {
//             CsucsmatrixSulyozatlanGraf g = new CsucsmatrixSulyozatlanGraf(6);
//             g.UjEl(0, 1);
//             g.UjEl(1, 2);
//             g.UjEl(1, 4);
//             g.UjEl(2, 3);
...
// 
//             string ut = "";
//             Halmaz<int> elertCsucsok = Bejarasok.SzelessegiBejaras(g, 0, (a) => { ut += a; });
// 
...
// 
//             string ut = "";
//             Halmaz<int> elertCsucsok = Bejarasok.MelysegiBejaras(g, 0, (a) => { ut += a; });
// 
